...
const Newsletter = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
      ...
      <p className='md:text-lg text-gray-500/70 pb-8'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Id ab hic esse sunt minima in a quae laboriosam autem voluptas.</p>
