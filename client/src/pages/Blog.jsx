  ...
  return data ? (
    <div className="relative">
      ...
      <div className="text-center mt-20 text-gray-600">
        ...
        <h1 className="text-2xl sm:text-5xl font-sans max-w-2xl mx-auto text-gray-800 ">
          {data.title}
        </h1>

        <h2 className="my-5 mx-auto truncate max-w-lg ">{data.subTitle}</h2>
      ...
      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
        <img src={data.image} alt="thumbnil" className="rounded-3xl mb-5" />
        ...
        <div className="mx-auto max-w-3xl mb-10 mt-14">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <button
              className="bg-primary p-2 text-white rounded px-8 cursor-pointer transition-all hover:scale-102"
              type="submit"
            >
              Submit
            </button>
